...
\begin{frame}{Connectivism: automatic learning by tuning the $a_{i\mbox{,\,}j}$, $b_i$ parameters}
\small
\vspace{0.2 cm}
\begin{columns}
...
\vspace{0.25 cm}
This is like setting a lot of $a_{i\mbox{,\,}j}$, $b_i$ fit parameters to zero and not letting them be tuned in the fit.
\end{frame}
