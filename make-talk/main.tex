...
\begin{frame}{A learning experience for me!}
\vspace{0.25 cm}
I've mostly been working on electoral precinct maps and address data, to help Native Americans comply with a new voter ID requirement in North Dakota. (Reservations don't get door-to-door mail delivery, so many people don't know their exact street address, but now it's required for voting.)

\vspace{0.75 cm}
\begin{uncoverenv}<2->
But recently, the Turtle Mountain Chippewa and Spirit Lake Sioux scored a major victory in overturning a blatent case of gerrymandering.
...
\normalsize
\vspace{0.25 cm}
\uncover<3->{I think it's a great illustration of how math, computing, and data analysis can be applied problems of justice, so let's get started!}
\end{frame}
